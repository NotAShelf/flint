...
func printFormattedOutput(deps map[string][]string, reverseDeps map[string][]string, options args.Options) {
...
func printPlainOutput(deps map[string][]string, reverseDeps map[string][]string, options args.Options) {
